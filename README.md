...
## Встановлення
### Готовий реліз для Windows
- Завантажте останній архів з розділу **Releases** на GitHub (файл `yt-downloader-*-windows.zip`).
- Розпакуйте архів у будь-яку теку та запустіть `yt-downloader.exe`.
- Архів уже містить `yt-dlp`, `ffmpeg`, `ffprobe` та Pillow, тому додаткове встановлення цих залежностей не потрібне.
...
> ℹ️ Якщо ви використовуєте готовий `.zip` з релізу, кроки 2–4 можна пропустити – потрібні утиліти вже знаходяться поруч із виконуваним файлом.
...
- У складі релізного архіву ці файли лежать у тій самій теці, що й `yt-downloader.exe`. Якщо ви їх випадково видалили або перемістили, просто повторно розпакуйте архів.
